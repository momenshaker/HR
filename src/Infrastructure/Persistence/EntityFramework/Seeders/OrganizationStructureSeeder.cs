    ...
    public static void Seed(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Employee>().HasData(
            new
            {
                ...
                PaySchedule = "Monthly",
                BasicSalary = 0m,
                JobArchitectureJobFamily = "Engineering",
                JobArchitectureJobFunction = "Platform",
                JobArchitectureJobLevel = "L7",
                JobArchitectureJobCode = "ENG-07",
                JobArchitectureCareerTrack = "Technology",
            ...
            new
            {
                ...
                JobArchitectureJobFamily = "Engineering",
                JobArchitectureJobFunction = "Platform",
                JobArchitectureJobLevel = "L6",
                JobArchitectureJobCode = "ENG-06",
                JobArchitectureCareerTrack = "Technology",
            ...
            new
            {
                ...
                BasicSalary = 0m,
                JobArchitectureJobFamily = "Engineering",
                JobArchitectureJobFunction = "Applications",
                JobArchitectureJobLevel = "L5",
                JobArchitectureJobCode = "APP-05",
                JobArchitectureCareerTrack = "Technology",
            ...
            new
            {
                ...
                PaySchedule = "Monthly",
                BasicSalary = 0m,
                JobArchitectureJobFamily = "People Ops",
                JobArchitectureJobFunction = "HR",
                JobArchitectureJobLevel = "L5",
                JobArchitectureJobCode = "HR-05",
                JobArchitectureCareerTrack = "People",
